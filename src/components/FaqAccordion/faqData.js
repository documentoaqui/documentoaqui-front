// Salve em: src/components/FaqAccordion/faqData.js

export const faqData = {
  "FAQ": [
    {
      "topic": "Sobre as Certidões",
      "subtopics": [
        { "question": "Quais tipos de certidão posso solicitar pelo site?", "answer": <p>Você pode solicitar certidões de nascimento, casamento, óbito, negativas de bens, protestos, matrícula de imóvel, entre outras emitidas por cartórios de todo o Brasil.</p> },
    ...
    {
      "topic": "Sobre Entrega e Envio",
      "subtopics": [
        { "question": "Como receberei minha certidão?", "answer": <p>Você pode optar por receber a certidão por e-mail (em formato digital, quando possível) ou pelos Correios, no endereço informado.</p> },
    ...
    {
      "topic": "Sobre Segurança e Privacidade",
      "subtopics": [
        { "question": "Vocês compartilham meus dados com terceiros?", "answer": <p>Somente com os cartórios e autoridades responsáveis para cumprir o serviço. Jamais vendemos ou divulgamos dados para outros fins.</p> },
        { "question": "Como posso excluir meus dados da plataforma?", "answer": <p>Basta entrar em contato com nossa equipe através da nossa página de Contato solicitando a exclusão de seus dados pessoais.</p> },
        { "question": "Meus dados bancários ficam armazenados?", "answer": <p>Não. Os pagamentos são processados por plataformas seguras e seus dados bancários não ficam salvos em nosso sistema.</p> }
      ]
    },
    {
      "topic": "Suporte e Contato",
      "subtopics": [
        { "question": "Como posso entrar em contato com vocês?", "answer": <p>Via WhatsApp, e-mail ou através da nossa página de Contato. Atendemos de segunda a sexta, das 9h às 17h.</p> },
        { "question": "Existe atendimento humano ou é tudo automatizado?", "answer": <p>Nosso atendimento é feito por pessoas reais, prontas para te ajudar com qualquer dúvida ou solicitação.</p> },
        { "question": "Posso alterar meu pedido depois de finalizado?", "answer": <p>Entre em contato o quanto antes através do WhatsApp ou da nossa página de Contato. Se o pedido ainda não tiver sido enviado ao cartório, conseguiremos alterar.</p> },
        { "question": "O serviço funciona em feriados e finais de semana?", "answer": <p>Pedidos podem ser feitos a qualquer momento, mas o atendimento e andamento seguem em dias úteis.</p> }
      ]
    },
    {
