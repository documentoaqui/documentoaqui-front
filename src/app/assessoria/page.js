...
export const metadata = {
  title: "Como Funciona - E-Certidões",
  description: "Informações sobre o funcionamento da plataforma.",
};
  ...
  const assessoriaDescription = (
    <>
      ...
      <ol>
        ...
        <p>Cada serviço possui informações de prazo, requisitos e valores.<br /></p>
        ...
        <p>Quando exigido pela LGPD (ex: <b>certidões em inteiro teor</b> do Registro Civil), o usuário também:</p>
